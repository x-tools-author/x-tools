...
#include "App/StyleSheetManager.h"
#endif
    ...
    , m_appPaletteActionGroup(nullptr)
{
    ...
    xTools::updateWindowTitle();
}

QIcon xTools::cookedIcon(const QString& svgFileName)
{
#ifdef X_TOOLS_ENABLE_MODULE_STYLESHEET
...
QIcon xTools::cookedIcon(const QIcon& icon)
{
#ifdef X_TOOLS_ENABLE_MODULE_STYLESHEET
...
QString xTools::qtConfFileName()
{
    return QCoreApplication::applicationDirPath() + "/qt.conf";
}

void xTools::initMenuFile()
{
...
void xTools::initMenuHelp()
{
    ...
    connect(m_aboutAction, &QAction::triggered, this, &xTools::onAboutActionTriggered);
}

void xTools::initOptionMenuAppStyleMenu()
{
...
void xTools::initOptionMenuSettingsMenu()
{
...
void xTools::initOptionMenuHdpiPolicy()
{
...
void xTools::initOptionMenuColorScheme()
{
...
void xTools::onHdpiPolicyActionTriggered(int policy)
{
    Settings::instance()->setHdpiPolicy(int(policy));
    tryToReboot();
}

void xTools::onAboutActionTriggered()
{
