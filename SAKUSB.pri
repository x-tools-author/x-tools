msvc {
    ...
    INCLUDEPATH += $${PWD}/$${USB_VERSION}/$${USB_SYSTEM_PLATFORM}/$${USB_CPU_ARCHITECTURE}/include
    LIBS += -L$${PWD}/$${USB_VERSION}/$${USB_SYSTEM_PLATFORM}/$${USB_CPU_ARCHITECTURE}/lib -llibusb-1.0
