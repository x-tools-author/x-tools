...
QByteArray Preset::itemBytes(const Item &item)
{
    QByteArray bytes;
...
QVariant Preset::columnDisplayRoleData(const Item &item, int column) const
{
    if (column >= 0 && column < headers().count()) {
...
QString Preset::cookHeaderString(const QString &str)
{
    ItemKeys keys;
...
QVariant Preset::itemContext(int index)
{
    QJsonObject ctx;
    mItemsMutex.lock();
...
QString Preset::description(int index)
{
...
QString Preset::itemDescription()
{
    return mDataKeys.itemDescription;
}

QString Preset::itemTextFormat()
{
    return mDataKeys.itemTextFormat;
}

QString Preset::itemEscapeCharacter()
{
    return mDataKeys.itemEscapeCharacter;
}

QString Preset::itemPrefix()
{
    return mDataKeys.itemPrefix;
}

QString Preset::itemSuffix()
{
    return mDataKeys.itemSuffix;
}

QString Preset::itemCrcEnable()
{
    return mDataKeys.itemCrcEnable;
}

QString Preset::itemCrcBigEndian()
{
    return mDataKeys.itemCrcBigEndian;
}

QString Preset::itemCrcAlgorithm()
{
    return mDataKeys.itemCrcAlgorithm;
}

QString Preset::itemCrcStartIndex()
{
    return mDataKeys.itemCrcStartIndex;
}

QString Preset::itemCrcEndIndex()
{
    return mDataKeys.itemCrcEndIndex;
}

QString Preset::itemText()
{
    return mDataKeys.itemText;
}

QStringList Preset::descriptions()
{
    mItemsMutex.lock();
    auto items = mItems;
    mItemsMutex.unlock();
