...
macro(x_remove_all_hex_editor_files)
  file(GLOB_RECURSE hex_editor_files "${CMAKE_CURRENT_SOURCE_DIR}/src/tools/hexeditor/*.*")
  foreach(file ${hex_editor_files})
...
if((NOT EXISTS "${X_3RD_DIR}/${file_name}") AND X_ENABLE_Q_HEX_EDIT)
  ...
  if(NOT unzip_result EQUAL 0)
    file(REMOVE "${X_3RD_DIR}/${file_name}")
