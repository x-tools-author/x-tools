...
elseif(LINUX AND NOT APPLE)
  set(src_file1 ${CMAKE_BINARY_DIR}/3rd/${package_name}/src/linux/libhidapi_hidraw.a)
  ...
  set(src_file2 ${CMAKE_BINARY_DIR}/3rd/${package_name}/src/linux/libhidapi_libusb.a)
  set(dst_file2 ${X_LIBS_DIR}/${package_name}/libusb/libhidapi_libusb.a)
  if(EXISTS ${src_file2})
