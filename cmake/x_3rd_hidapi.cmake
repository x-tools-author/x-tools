...
elseif(APPLE)
  set(src_file ${CMAKE_BINARY_DIR}/3rd/${package_name}/src/mac/libhidapi.a)
  set(dst_file ${X_LIBS_DIR}/${package_name}/lib/libhidapi.a)
  if(EXISTS ${src_file})
    if(NOT EXISTS ${dst_file})
      execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different ${src_file} ${dst_file})
    endif()
...
elseif(LINUX AND NOT APPLE)
  set(src_file1 ${CMAKE_BINARY_DIR}/3rd/${package_name}/src/linux/libhidapi-hidraw.a)
  set(dst_file1 ${X_LIBS_DIR}/${package_name}/lib/libhidapi_hidraw.a)
  if(EXISTS ${src_file1})
    if(NOT EXISTS ${dst_file1})
      execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different ${src_file1} ${dst_file1})
    endif()
  endif()

  set(src_file2 ${CMAKE_BINARY_DIR}/3rd/${package_name}/src/libusb/libhidapi-libusb.a)
  set(dst_file2 ${X_LIBS_DIR}/${package_name}/lib/libhidapi_libusb.a)
  if(EXISTS ${src_file2})
    if(NOT EXISTS ${dst_file2})
      execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different ${src_file2} ${dst_file2})
    endif()
  endif()
