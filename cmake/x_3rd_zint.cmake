...
macro(x_remove_zint_files)
  ...
  endforeach()
  add_compile_definitions(X_ENABLE_ZINT=0)
endmacro()
...
if(NOT EXISTS "${CMAKE_SOURCE_DIR}/3rd/${file_name}.zip")
  ...
  if(NOT download_status EQUAL 0)
    ...
    file(REMOVE "${CMAKE_SOURCE_DIR}/3rd/${file_name}.zip")
    x_remove_zint_files()
    return()
  endif()
endif()
...
if(EXISTS "${X_LIBS_DIR}/${file_name}/include/zint.h")
  ...
  if(NOT zint_FOUND)
    message(WARNING "[xTools.Zint] Failed to find Zint in ${X_LIBS_DIR}/${file_name}")
    x_remove_zint_files()
    return()
  endif()
  ...
  # lib64
  set(src_file ${X_LIBS_DIR}/${file_name}/lib64/libzint.a)
  set(dst_file ${X_LIBS_DIR}/${file_name}/lib64/libzint-static.a)
  if(EXISTS ${src_file})
    if(NOT EXISTS ${dst_file})
      execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different ${src_file} ${dst_file})
    endif()
