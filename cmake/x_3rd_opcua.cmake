...
macro(x_remove_all_opcua_files)
  ...
  endforeach()
  add_compile_definitions(X_ENABLE_X_OPCUA=0)
  return()
endmacro()
...
option(X_ENABLE_X_OPCUA "Enable OPC UA support via Qt OPC UA module" OFF)
if(NOT X_ENABLE_X_OPCUA)
  x_remove_all_opcua_files()
  return()
endif()
...
add_compile_definitions(X_ENABLE_X_OPCUA=1)
