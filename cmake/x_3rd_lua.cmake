...
if(ON)
  if(EXISTS ${lua_lib_file})
    ...
    add_library(liblua STATIC ${LUA_FILES})
    set_target_properties(liblua PROPERTIES FOLDER "3rd")
    set_target_properties(liblua PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${lua_lib_dir})
  endif()
endif()
