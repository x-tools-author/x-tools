...
class CoAPOptionModelPrivate;
class CoAPOptionModel : public QAbstractTableModel
{
    Q_OBJECT
    CoAPOptionModelPrivate *d;

public:
    explicit CoAPOptionModel(QObject *parent = nullptr);
    ~CoAPOptionModel() override;
