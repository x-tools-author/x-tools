...
public:
        ...
        , q(q_ptr)
    {
        ...
        QAction* exportAction = m_toolButtonMenu->addAction(
            QObject::tr("Export CoAP Configuration"));
        exportAction->setIcon(xIcon(":res/icons/save.svg"));
        QAction* importAction = m_toolButtonMenu->addAction(
            QObject::tr("Import CoAP Configuration"));
        importAction->setIcon(xIcon(":res/icons/file_open.svg"));
        m_toolButtonMenu->addSeparator();
        QAction* settingAction = m_toolButtonMenu->addAction(QObject::tr("Global Settings"));
        ...
        QAction* cacheAction = m_toolButtonMenu->addAction(QObject::tr("Open Server Cache Path"));
        ...
        m_clientCtrlToolButton->setToolTip(QObject::tr("Show/Hide Client View"));
        m_serverCtrlToolButton->setToolTip(QObject::tr("Show/Hide Server View"));
