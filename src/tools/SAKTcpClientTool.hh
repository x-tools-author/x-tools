 ...
 *****************************************************************************/
#ifndef EDTCPCLIENTTOOL_HPP
#define EDTCPCLIENTTOOL_HPP

#include <QTcpSocket>
#include "EDBaseTool.hpp"

class EDTcpClientTool : public EDBaseTool
{
    Q_OBJECT
...
public:
    explicit EDTcpClientTool(QObject *parent = nullptr);
