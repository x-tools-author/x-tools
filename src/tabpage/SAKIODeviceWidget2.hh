 ...
 */
#ifndef SAKIODEVICEWIDGET_HH
#define SAKIODEVICEWIDGET_HH
...
namespace Ui {
class SAKIODeviceWidget2;
}

class SAKIODeviceWidget2 : public QWidget
{
    Q_OBJECT
public:
    SAKIODeviceWidget2(SAKIODevice *_device, SAKIODeviceControler *_controler, QWidget *parent = Q_NULLPTR);
    ~SAKIODeviceWidget2();
