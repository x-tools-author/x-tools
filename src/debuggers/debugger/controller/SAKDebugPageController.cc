...
SAKDebugPageController::SAKDebugPageController(SAKDebugger *debugPage, QWidget *parent)
    :QWidget(parent)
    ,mDebugPage(debugPage)
{
    connect(this, &SAKDebugPageController::messageChange, mDebugPage, &SAKDebugger::outputMessage);
}
