...
NodeEditorNavigator::NodeEditorNavigator(QWidget *parent)
    : QWidget(parent)
{
...
NodeEditorNavigator::~NodeEditorNavigator() {}

void NodeEditorNavigator::setupScrollArea(QScrollArea *scrollArea)
{
...
bool NodeEditorNavigator::eventFilter(QObject *watched, QEvent *event)
{
...
void NodeEditorNavigator::paintEvent(QPaintEvent *event)
{
...
void NodeEditorNavigator::mousePressEvent(QMouseEvent *event)
{
...
void NodeEditorNavigator::mouseMoveEvent(QMouseEvent *event)
{
...
void NodeEditorNavigator::updateRect()
{
