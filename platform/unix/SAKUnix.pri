...
# If you meet the error: "Cannot mount AppImage, please check your FUSE setup."
# You should run "linuxdeployqt --appimage-extract", it will generate a dir and you should add the dir to path,
# then using CONFIG+=SAKLinuxDeployQtAppRun
SAKLinuxDeployQt {
...
SAKLinuxDeployQtAppRun {
    ...
    QMAKE_POST_LINK += 'AppRun $${OUT_PWD}/qsak/share/applications/QtSwissArmyKnife.desktop -qmake=$${QMAKE_QMAKE} -verbose=2 -appimage $$escape_expand(\\n\\t)'
}
