...
# The file was create by Qsaker(qsaker@foxmail.com) on September 30, 2019.
...
contains(CONFIG, static){
    ...
    win32 {
        ...
        msvc {
            contains(CONFIG, SAKQmlUi) {
                QMAKE_POST_LINK+=$${DEPLOY_TOOL} $${DEPLOY_TARGET} --no-translations --qmldir $$PWD/qml $$escape_expand(\\n)
            } else {
                QMAKE_POST_LINK+=$${DEPLOY_TOOL} $${DEPLOY_TARGET} --no-translations $$escape_expand(\\n)
            }
        } else {
