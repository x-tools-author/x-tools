 ...
 */
#include "SAKBase.hh"
#include "TimingSendingItem.hh"

#include <QDebug>
#include <QDateTime>

TimingSendingItem::TimingSendingItem(SAKDebugPage *debugPage, QWidget *parent)
    :QWidget(parent)
    ,ui (new Ui::TimingSendingItem)
...
TimingSendingItem::~TimingSendingItem()
{
    delete ui;
}

void TimingSendingItem::setAllAutoResponseDisable(bool disAbel)
{
    forbiddenAllAutoResponse = disAbel;
}

void TimingSendingItem::setLineEditFormat(QLineEdit *lineEdit, int format)
{
...
void TimingSendingItem::dataRead(QByteArray data)
{
...
QByteArray TimingSendingItem::string2array(QString str, int format)
{
...
bool TimingSendingItem::response(QByteArray receiveData, QByteArray referenceData, int option)
{
...
void TimingSendingItem::on_referenceDataFromatComboBox_currentTextChanged()
{
    setLineEditFormat(referenceLineEdit, referenceDataFromatComboBox->currentData().toInt());
}

void TimingSendingItem::on_responseDataFormatComboBox_currentTextChanged()
{
