...
x_deploy_qt(xHash)
x_using_x_tools_translations(xHash)
target_link_libraries(xHash PRIVATE Qt::CorePrivate Qt::Svg Qt::Widgets)
if(X_USING_VS_CODE)
...
if(WIN32)
  ...
  x_generate_msix(xHash "xHash" "xHash" "${x_hash_version}" FALSE)
elseif(LINUX)
