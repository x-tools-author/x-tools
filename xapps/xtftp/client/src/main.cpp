...
#include "tools/tftp/client/tftpclient.h"

int main(int argc, char *argv[])
{
    QApplication::setOrganizationName("xTools");
    QApplication::setApplicationName("xTftpClient");
    QApplication::setApplicationVersion(QString(X_TFTP_CLIENT_VERSION));
    ...
    xUi window;
    TftpClient *tftpClient = new TftpClient(&window);
    window.setCentralWidget(tftpClient);
